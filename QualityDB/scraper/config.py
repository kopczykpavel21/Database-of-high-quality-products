import os
# Read from environment first (fly.toml sets DB_PATH=/data/products.db on fly.io).
# Fall back to local path for dev.
DB_PATH = os.environ.get(
    "DB_PATH",
    os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "products.db"),
)
