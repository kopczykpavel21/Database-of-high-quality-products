...
if __name__ == "__main__":
    ...
    def _background_init():
        ...
        #     It ran on EVERY restart, destroying all real Alza price history.
        #     Real snapshots from the local Alza scraper must persist across
        #     restarts, so this cleanup is intentionally gone.
